...
TOKEN = '8041759338:AAEQx6mQVjIAmEtGJJGB-jAtev9Fi9qZqiM'
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@Mk_ddos*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@Mk_ddos*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("MONSTER 👹  SERVER RUNNING.....")
    while True:
        try:
